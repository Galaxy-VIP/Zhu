...
module.exports = {
    ...
    execute: async (client, interaction, args) => {
        ...
        collector.on("collect", async i => {
            ...
            //ActiveRole
            if(member.roles.cache.has('1152818399366365215')) {
                 await user.roles.remove('1152818399366365215')
            } else {
                return
            }
            //VeryActiveRole
            if(user.roles.cache.has('1152818715470082058')) {
                await user.roles.remove('1152818715470082058')
            }else{
                return
            }
            //HyperactiveRole
            if(user.roles.cache.has('1152819047101120534')) {
                await user.roles.remove('1152819047101120534')
            }else{
                return
            }
            //SuperActiveRole
            if(user.roles.cache.has('1152819292803448852')) {
                await user.roles.remove('1152819292803448852')
            } else {
                return
            }
                //SuperDuperActiveRole
                if(user.roles.cache.has('1152819453642412172')) {
                await user.roles.remove('1152819453642412172') 
            } else {
                return
            }
