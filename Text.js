 ...
 exports.run = async(client, message) => {
   ...
   if (message.content.startsWith(prefix)) {
     ...
     if(commandfile.ownerOnly) {
       if(!['671351376642834440', '1005082777206661190', '627027667685867530', '465491570305662978'].includes(msg.author.id)) {
         return
       }
     }
    ...
    commandfile.run(client, message, args); 
           ...
           .setDescription("System mendeteksi adanya error pada command "+commandfile.name)
