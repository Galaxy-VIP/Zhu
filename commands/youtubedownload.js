...
module.exports = {
    ...
    run: async (client, msg, args) => {
            ...
            if(!query) return msg.channel.send({ content: lang(msg.guild, "ENTER_NAME_SONG") })
            const wait = await msg.channel.send({ content: `${lang(msg.guild, "SEARCHING_MUSIC")} \`${query}\`...` })
...
${lang(msg.guild, "NAME")}: \`${music.name}\`
                     ...
                     collector.on("collect", async (i) => {
                      ...
                      if(i.user.id === msg.author.id) {
                         if(i.customId === "download") {
                             ...
                             .setColor("YELLOW")
                             .setDescription(`<a:1606download:871703562399416342> ${lang(msg.guild, "DOWNLOADING")}... (15%)`)
                              const downloadWait2 = new discord.MessageEmbed()
                             .setColor("YELLOW")
                             .setDescription(`<a:1606download:871703562399416342> ${lang(msg.guild, "DOWNLOADING")}... (45%)`)
                               const downloadWait3 = new discord.MessageEmbed()
                             .setColor("YELLOW")
                             .setDescription(`<a:1606download:871703562399416342> ${lang(msg.guild, "DOWNLOADING")}... (75%)`)
                                 const downloadWait4 = new discord.MessageEmbed()
                             .setColor("YELLOW")
                             .setDescription(`<a:1606download:871703562399416342> ${lang(msg.guild, "DOWNLOADING")}... (100%)`)
                                   const downloadSuccess = new discord.MessageEmbed()
                             .setColor("GREEN")
                             .setDescription(lang(msg.guild, "DOWNLOAD_SUCCESS"))
                                   const downloadFailed = new discord.MessageEmbed()
                                   .setColor("RED")
                                   .setDescription(stripIndents`
                                   ${lang(msg.guild, "FILE_SENT_FAILED")}`)
                             ...
                             setTimeout(async function() {
                              ...
                              setTimeout(async function() {
                                 ...
                                 const file = new discord.MessageAttachment(tes, music.name+".mp3")
